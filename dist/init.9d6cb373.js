...
function initButtons(handleUserAction) {
  ...
  function buttonClick(_ref) {
    ...
    if (target.classList.contains("left-btn")) {
      ...
      selectedIcon = (1 + selectedIcon) % _constant.ICONS.length;
      // console.log("selectedIcon right", selectedIcon);
      toggleHighlighted(selectedIcon, true);
    } else {
      console.log("ICONS ", _constant.ICONS[selectedIcon]);
      0;
      handleUserAction(_constant.ICONS[selectedIcon]);
    }
  }
...
var _gameState = _interopRequireWildcard(require("./gameState.js"));
var _constant = require("./constant.js");
        ...
        case 0:
          nextAnimationFrame = function _nextAnimationFrame() {
            ...
            if (nextTimeToTick <= now) {
              ...
              nextTimeToTick = now + _constant.TICK_RATE; // 5 + 3 = 8
            }
...
init();
},{"./gameState.js":"gameState.js","./constant.js":"constant.js","./buttons.js":"buttons.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
